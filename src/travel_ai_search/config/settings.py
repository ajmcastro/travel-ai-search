...
class Settings(BaseSettings):
    ...
    #   When set, scripts/evaluate.py --strategy fine-tuned-vector loads this model
    #   instead of embedding_model_name.  Leave empty to use the base model.
    #   Generated by: make prepare-fine-tuning-data && make fine-tune-embeddings
    fine_tuned_embedding_model_path: str = ""
